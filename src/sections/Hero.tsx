										...
										<div className="space-y-3">
											...
											<div className="p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
												<p className="text-xs text-gray-600 dark:text-gray-300">
													...
													A refined testimonials section to build trust with
													potential clients.
												</p>
											</div>
											<div className="p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
												<p className="text-xs text-gray-600 dark:text-gray-300">
													...
													A fully styled contact form specifically designed for
													catering requests.
												</p>
											</div>
											<div className="p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
												<p className="text-xs text-gray-600 dark:text-gray-300">
													...
													Optimized for seamless browsing on tablets and
													smartphones.
												</p>
											</div>
										</div>
										<div className="mt-auto pt-4">
											...
											<div className="relative">
												...
												<div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
													...
													<span className="text-[10px] px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded">
														Gemini 3 Flash
													</span>
										...
										<div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden h-full">
											<div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
												...
												<div className="flex gap-2">
													<span className="px-3 py-1 text-xs border border-gray-200 dark:border-gray-700 rounded-full">
														Appetizers
													</span>
													<span className="px-3 py-1 text-xs border border-gray-200 dark:border-gray-700 rounded-full">
														Main Course
													</span>
													<span className="px-3 py-1 text-xs bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full">
														Desserts
													</span>
												</div>
											</div>
